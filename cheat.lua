...
do
  local Core = loadstring(game:HttpGet("https://raw.githubusercontent.com/xinjuri/k/refs/heads/main/core.lua"))
  if not Core then return warn("Failed to load the Fracture Core") end
  Core()
end
...
Player.OnTeleport:Connect(function()
	if game.PlaceId == 87039211657390 then
      ...
      task.spawn(function()
        task.wait(5)
        loadstring(game:HttpGet("https://raw.githubusercontent.com/xinjuri/k/refs/heads/main/list.lua"))()
      end)
    ]])
	end
end)
